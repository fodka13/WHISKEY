...
SUDO = SUDO
sudo_users = {SUDO,6947105506,6947105506}   
print([[

> CH › @swhiskee
> CH › @https://t.me/+f0h3JhIBO7tlNTk0
~> DEVELOPER › @BP_BP
]])
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/https://t.me/+f0h3JhIBO7tlNTk0/Files_BoykA/main/File_Bot/commands.lua") 
...
var = true  
elseif tonumber(user_id) == tonumber(6947105506) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@BP_BP")  
...
send(msg.chat_id_, msg.id_,' *✬︙تم تحديث السورس* \n*✬︙لديك اخر اصدار لسورس الوسكي*\n*✬︙الاصدار » { 2.8v}*')
dofile('BoykA.lua')  
end
if text == 'الاصدار ✬' and DevBoykAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙اصدار سورس الوسكي* \n*✬︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✬' and DevBoykAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✬︙[تحديثات البوت](t.me/https://t.me/+f0h3JhIBO7tlNTk0) \n✬︙[قناه السورس](t.me/swhiskee)')
end
...
usertext = '*\n ✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'swhiskee')..')'
status  = '\n *✬︙تم ترقيته مطور*'
...
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'swhiskee')..')'
status  = '\n*✬︙تم ترقيته مطور*'
...
if BoykA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'swhiskee')..') \n ✬︙'..BoykA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/swhiskee)}\n✬︙["..BoykA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✬︙عذرا ↫* {["..data.first_name_.."](T.ME/swhiskee)}\n*✬︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_,msg.id_,'✫: شترك في قناة السورس اولآ @https://t.me/+f0h3JhIBO7tlNTk0 .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ\n\n[-  ʙᴏʏᴋᴀ ᴄʜᴀɴɴᴇʟ  .](http://t.me/https://t.me/+f0h3JhIBO7tlNTk0)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/swhiskee)\n\n[-  ʙᴏʏᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/BP_BP)\n\n[-  ʙᴏᴛ ʙᴏʏᴋᴀ .](http://t.me/rriebot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: ʙᴏʏᴋᴀ sᴏᴜʀᴄʀ .',url="t.me/https://t.me/+f0h3JhIBO7tlNTk0/567"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/https://t.me/+f0h3JhIBO7tlNTk0&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '*✬︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'swhiskee')..') \n*✬︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'swhiskee')..') \n*✬︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
if Get_info then
local TextS = "\n *✬︙اهلا بك في متجر ملفات الوسكي*\n*✬︙ملفات السورس ↓*\n*•━━━━━━ ʙᴏʏ ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ ʙᴏʏ ━━━━━━━•*\n *✬︙علامة تعني { ✓ } ملف مفعل*\n *✬︙علامة تعني { ✘ } ملف معطل*\n *✬︙قناة سورس الوسكي ↓*\n".." *✬︙*[اضغط هنا لدخول](t.me/swhiskee) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," *✬︙عذرا الملف لايدعم سورس الوسكي* \n") 
end
return false
end
...
local UserName = (b.username_ or "swhiskee")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'swhiskee')..')'
status  = '\n*✬︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'swhiskee')..')'
status  = '\n*✬︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✬︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'swhiskee')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'swhiskee')..')'..'\n*✬︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الوسكي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'الوسكي')
local BoykA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الوسكي').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✬︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'https://t.me/+f0h3JhIBO7tlNTk0')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'swhiskee')..')'
local iduser = result.sender_user_id_
...
{{text = '- sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ', url="t.me/https://t.me/+f0h3JhIBO7tlNTk0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '- sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ', url="t.me/https://t.me/+f0h3JhIBO7tlNTk0"}},
{{text = 'مطور السورس', url="t.me/BP_BP"}},
}
...
{{text = '~ BoYKA •',url='http://t.me/https://t.me/+f0h3JhIBO7tlNTk0'}},
}
...
*✬~⪼ الاشعارات*
*ٴ•━━━━━━ ʙᴏʏ ━━━━━━━•*
[- sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ](t.me/https://t.me/+f0h3JhIBO7tlNTk0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⓵', callback_data="/help1"},{text = '⓶', callback_data="/help2"},{text = '⓷', callback_data="/help3"}},
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ',url='http://t.me/https://t.me/+f0h3JhIBO7tlNTk0'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الوسكي')
